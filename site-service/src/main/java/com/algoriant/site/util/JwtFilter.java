package com.algoriant.site.util;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private static final String URL = "http://localhost:8081/auth/validateToken?token=";

    private static final String URL_PA = "http://localhost:8081/auth/getUserDetail?token=";
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        ResponseEntity<String> template_response = template.exchange(URL + token, HttpMethod.GET,
                entity, String.class);
